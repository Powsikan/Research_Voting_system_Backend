...
public class CandidateController {
    ...
    @PostMapping("/add")
    public String addCandidate(@RequestParam("file") MultipartFile file , @RequestParam String name ,@RequestParam String party) {
        return candidateService.addCandidate(file,name,party);
