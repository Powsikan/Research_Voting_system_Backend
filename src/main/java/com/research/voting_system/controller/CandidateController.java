...
public class CandidateController {
    ...
    @PostMapping("/add")
    public String addCandidate(@RequestParam("file") MultipartFile file, @ModelAttribute Candidate newCandidate) {
        return candidateService.addCandidate(file, newCandidate);
